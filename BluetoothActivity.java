...
public class BluetoothActivity extends AppCompatActivity {
    ...
    @OnClick(R.id.send_button) void send() {
        // Send an item_message using content of the edit text widget
        //String message = editText.getText().toString();
        String message = "Check";
        //String message = editText.setText();
    ...
    private class myHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            String classes[] = {"OK","Danger","Falling","Problem"};
            String checkStatus;
...
//Abhishek: my code. Oh yeah!!!!!
                    if (readMessage != null && activity.showMessagesIsChecked) {
                        ...
                        checkStatus = readMessage.trim();
                        Log.d("Outer if", checkStatus);
                        int len = checkStatus.length();
                        Log.d("length",String.valueOf(len));

                        try {
                            if((readMessage.contentEquals("OK\n") || readMessage.contentEquals("Danger") || readMessage.contentEquals("Falling"))) {
                            //if(checkStatus.equals("OK")) {
                                Class ourClass = Class.forName("com.menthoven.arduinoandroid."+checkStatus);
                                Intent ourIntent = new Intent(BluetoothActivity.this, ourClass);
                                Log.d("Inside if",checkStatus);
                                //Activity currActivity = appConstantsObj.getCurrentActivity();

                                startActivity(ourIntent);
                            }
                            else {
                                Class ourClass = Class.forName("com.menthoven.arduinoandroid.Problem");
                                Intent ourIntent = new Intent(BluetoothActivity.this, ourClass);
                                Log.d("Inside else",checkStatus);
                                startActivity(ourIntent);
                            }
